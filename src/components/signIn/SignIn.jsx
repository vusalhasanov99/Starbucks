...
function SignIn() {
    ...
    const datas = [
        {
            name: "email",
            label: "* Username or email address", err: "Enter an email/username.", type: "text",
        ...
        <>
            {register ? <JoinNow /> : <form className='signIn'>
                ...
                <div className="sign">
                    ...
                    {datas.map((item, i) => (
                        <Form key={nanoid()} {...item} forv={arr[i]} />
                    ))}
