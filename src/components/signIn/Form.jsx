...
function Form({ label, type, err, show, hide, x, name,forv }) {
    ...
    return (
        <div className="inp">
            ...
            <input style={{ border: value.length > 0 || blur ? "1px solid " : "1px solid red" }} ref={forv} value={value} name={name} type={view ? "text" : type} onBlur={changeBlur} onFocus={() => setStatus(true)} onChange={changeValue} />
