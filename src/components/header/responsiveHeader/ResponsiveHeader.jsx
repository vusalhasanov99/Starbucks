...
function ResponsiveHeader() {
    ...
    return (
        <div className='responsiveHeader' >
            ...
            <div className="menuHeaderBg" onClick={() => setTransform(false)} style={{display:transform?"block":"none"}}></div>
            <div className="menuHeader" style={{ transform: transform ? "translate(-86%)" : "translate(200%)" }}>
                <ul>
                ...
                <div>
                    <div>
                        <NavLink to="account/signin" onClick={() => dispatch(logout())}><button className='btn btnOutline'>Log out</button></NavLink>
                    </div>
                ...
                <div className="menuAllProducts" style={{ transform: menuTransform ? "translate(-14%)" : "translate(200%)" }}>
                    <ul>
